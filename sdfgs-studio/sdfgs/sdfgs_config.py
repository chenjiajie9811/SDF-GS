...
from sdfgs.scaffoldgs_neus_model import ScaffoldGaussianNeuSModelConfig
from sdfgs.scaffoldgs_neus_pipeline import ScaffoldGSNeuSPipelineConfig
...
SDFGS = MethodSpecification(
    config=TrainerConfig(
        ...
        max_num_iterations=30000,
        mixed_precision=False,
        pipeline=ScaffoldGSNeuSPipelineConfig(
            model=ScaffoldGaussianNeuSModelConfig(),
        ),
        optimizers={
            "anchor": {
                "optimizer": AdamOptimizerConfig(lr=0.0, eps=1e-15),
