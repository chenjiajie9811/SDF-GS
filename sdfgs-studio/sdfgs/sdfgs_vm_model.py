...
# @dataclass
# class TriPlaneNeuSModelConfig(NeuSModelConfig):

#     _target: Type = field(default_factory=lambda: TriPlaneNeuSModel)
...
# class TriPlaneNeuSModel(NeuSModel):


#     config: TriPlaneNeuSModelConfig
